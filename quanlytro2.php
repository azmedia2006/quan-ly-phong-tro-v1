...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'add') {
    ...
    header("Location: quanlytro2.php");
    exit;
}
...
<head>
    ...
    <title>Quản lý Trọ: Trọ Sinh Viên 2</title>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="quanlytro2.php" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="quanlytro2.php?delete=<?php echo $kost['id']; ?>" 
