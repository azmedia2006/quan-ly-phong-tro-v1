...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'add') {
    ...
    header("Location: quanlytro3.php");
    exit;
}
...
<head>
    ...
    <title>Quản lý Trọ: Trọ Cao Cấp</title>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="quanlytro3.php" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="edit_no_kamar" name="no_kamar" required>
                                            <?php foreach ($all_rooms as $room): ?>
                                                <?php 
                                                $tt = 'Trống';
                                                if ($room['status'] == 'Đã thuê') $tt = 'Đã thuê';
                                                if ($room['status'] == 'Đang sửa chữa') $tt = 'Đang sửa';
                                                ?>
                                                <option value="<?php echo htmlspecialchars($room['no_kamar']); ?>">
                                                    Phòng <?php echo htmlspecialchars($room['no_kamar']); ?> (<?php echo $tt; ?>)
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="quanlytro3.php?delete=<?php echo $kost['id']; ?>" 
